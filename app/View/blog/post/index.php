    ...
    <div class="registerForm">
        <table class="form">
            ...
            <tr>
                ...
                <td>
                    <textarea type="text" name="Content" placeholder="Content" id="Content" data-provide="markdown"
            ...
            <tr>
                ...
                <td>
                    <input type="datetime-local" name="Date" value="<?php echo date('Y-m-d H:i'); ?>"
                           placeholder="yyyy-mm-dd hh:mm" min="<?php echo date('Y-m-d H:i'); ?>" id="Date" required>
                </td>
            </tr>
            <tr>
                <td>
