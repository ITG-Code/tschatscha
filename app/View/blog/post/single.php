        ...
        <?php foreach ($data->comments as $comment) {
            if ($comment->parent_id == NULL){?>
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Skriven av: <?php if ($comment->name === NULL) {$comment->name = 'Anonym';}?><?= htmlentities($comment->name) ?></h3>
                </div>
                <div class="panel-body">
                ...
                <?php } if (($data->loggedin == $comment->sessionid) && $comment->name != 'Anonym'  ) {?>
                <form name="edit"
                ...
                if ($reply->parent_id == $comment->id){?>
                    <section class="panel panel-default" >
                        ...
                        <div class="panel-footer">
                            ...
                            <?php } if ($data->loggedin == $comment->sessionid ) {?>
                                <form name="edit"
                                      action="/<?= $data->blogname ?>/editComment"
                                      method="post">
                                    <textarea class="form-control" name="content" id="content" rows="3"
